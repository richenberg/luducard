...
total-games = Hry
file-size = Velikost
file-location = UmÃ­stÄ›nÃ­
overall = Overall
status = Stav
cli-unrecognized-games = Å½Ã¡dnÃ© informace pro tyto hry:
cli-unable-to-request-confirmation = Nepovedlo se zÃ­skat potvrzenÃ­.
...
button-backup = ZÃ¡lohovat
button-preview = NÃ¡hled
...
button-add-game = PÅ™idat hru
button-continue = Continue
button-cancel = ZruÅ¡it
button-cancelling = RuÅ¡enÃ­...
button-okay = Okay
button-select-all = Vybrat vÅ¡e
button-deselect-all = Deselect all
button-enable-all = Povolit vÅ¡e
