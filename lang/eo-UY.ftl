...
overall = Entute
status = Stato
cli-unrecognized-games = Neniuj informoj pri Ä‰i tiuj ludoj:
...
badge-duplicates = DUPLIKAÄ´OJ
badge-duplicated = DUPLIKITA
badge-ignored = IGNORITAS
badge-redirected-from = DE: { $path }
badge-redirecting-to = AL: { $path }
some-entries-failed = Kelkaj enskriboj malsukcesis procesi; serÄ‰u { badge-failed } en la eligo por detaloj. Duoble kontrolu Ä‰u vi povas aliri tiujn dosierojn aÅ­ Ä‰u iliaj vojoj estas tre longaj.
...
button-preview = AntaÅ­rigardo
button-restore = RestaÅ­ri
...
button-okay = Enorde
button-select-all = Elekti Ä‰iujn
button-deselect-all = Malelekti Ä‰iujn
...
button-lock = Åœlosi
button-unlock = MalÅlosi
# This opens a download page.
button-get-app = ElÅuti { $app }
