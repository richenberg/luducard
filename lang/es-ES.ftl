...
luducard-backup-kind-quick = Guardado rápido
luducard-add-version-note = Añadir una nota...
luducard-versioning = Versionado de partidas
luducard-versioning-desc = Mantiene un historial de partidas anteriores en lugar de sobrescribir la última. Las partidas fijadas se conservan siempre, sin importar los límites.
luducard-retention-full = Copias completas a conservar
luducard-retention-full-desc = Cada una guarda todos los archivos de partida del juego. Más copias significa más protección y más disco usado.
luducard-retention-differential = Copias incrementales por cada completa
luducard-retention-differential-desc = Guardan solo lo que cambió desde la última copia completa, así que son mucho más pequeñas. Los puntos de restauración son copias completas × (1 + este número).
