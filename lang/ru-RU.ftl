...
luducard-backup-kind-quick = Быстрое сохранение
luducard-add-version-note = Добавить заметку...
luducard-versioning = Версионирование сохранений
luducard-versioning-desc = Хранит историю прежних сохранений вместо перезаписи последнего. Закреплённые сохранения хранятся всегда, независимо от лимитов.
luducard-retention-full = Сколько полных копий хранить
luducard-retention-full-desc = Каждая содержит все файлы сохранений игры. Больше копий — надёжнее, но больше места на диске.
luducard-retention-differential = Разностных копий на каждую полную
luducard-retention-differential-desc = Содержат только изменения с последней полной копии, поэтому намного меньше. Точек восстановления: полные копии × (1 + это число).
